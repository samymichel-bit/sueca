    ...
    <div class="container mx-auto px-4">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-12">
        <div v-for="member in teamMembers" :key="member.id" class="group">
          <div class="relative overflow-hidden rounded-3xl bg-noir border border-blanc/10 shadow-2xl hover:shadow-menthe hover:-translate-y-4 transition-all duration-500 h-96 flex items-end p-8">
